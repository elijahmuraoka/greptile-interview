...
export const fakeChangelog: ChangelogWithEntries = {
    ...
    summary:
        'This release includes several new features, performance improvements, and bug fixes.',
    ...
    entries: [
        {
            ...
            impact: 'Users can now switch between light and dark themes for better viewing experience in different lighting conditions.',
            technicalDetails:
        ...
        },
        {
            ...
            userBenefit:
                'Faster page loads and improved overall application responsiveness.',
            breakingChange: false,
            pullRequests: [
                {
                    id: 'pr789012',
        ...
        },
        {
            ...
            technicalDetails:
                'Switched to JWT-based authentication and implemented refresh tokens.',
            userBenefit:
